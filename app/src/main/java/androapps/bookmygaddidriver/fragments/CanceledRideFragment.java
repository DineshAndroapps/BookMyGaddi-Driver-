 ...
 */
public class CanceledRideFragment extends Fragment implements ApiResponse {
    ...
    public void onResume() {
        super.onResume();
//        nodata.setVisibility(View.VISIBLE);
//        nodata.setText("Coming Soon");
        checkConnectionAndProceed();
    }

    private void getRides() {
        NetworkRequest.sendStringRequest(getContext(), Constants.Urls.CANCELED_RIDE, params, this, Constants.APICodes.CANCELED_RIDE);
    ...
    public void NetworkRequestCompleted(int apiCode, JSONObject response, ProgressDialog progressDialog) {
        ...
        switch (apiCode) {
            case Constants.APICodes.CANCELED_RIDE: {
                ...
                try {
                    ...
                    RidesAdapter ridesAdapter = new RidesAdapter(getActivity(), ridesDetailses,"Canceled");
